...
def pdlp_algorithm(K, m_ineq, c, q, l, u, device, max_kkt=100_000, tol=1e-4, verbose=True, restart_period=40, precondition=False, primal_update=False, adaptive=False, data_precond=None, time_limit=3600, time_used=0, x_init=None, y_init=None):
    ...
    if x_init is not None and y_init is not None:  # Use provided init
