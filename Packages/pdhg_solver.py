...
def restarted_solver(mps_file_path, tol=1e-4, restart_period=40, verbose=True, max_iter=100_000):
    ...
    Returns:
      The minimizer, objective value, and number of iterations and restarts for convergence.
    """
    import torch
    from mps_to_standard_form import mps_to_standard_form_torch
    from restarted_pdhg_algorithm import restarted_pdhg
    ...
    return minimizer, objective_value, total_iterations, total_restarts
