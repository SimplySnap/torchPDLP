...
class Args:
    device = 'gpu'
    instance_path = '/home1/cphillips/PDLP-AMD-RIPS/datasets/Netlib/infeasible'
    tolerance = 1e-8
    output_path = '/home1/cphillips/PDLP-AMD-RIPS/datasets/Netlib/infeasible'
    precondition = True
    ...
    for mps_file in mps_files:
        ...
        try:
            with Timer("Solve time") as t:
                ...
                x, prim_obj, k, n, j = pdlp_algorithm(K, m_ineq, c, q, l, u, device, max_iter=100000, tol=tol, verbose=True, restart_period=40, precondition=precondition,primal_update=primal_weight_update, adaptive=adaptive_stepsize, data_precond=dt_precond)
