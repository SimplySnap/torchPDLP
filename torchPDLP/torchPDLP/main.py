...
import .spectral_casting as fishnet_casting


def solve(mps_file_path, tol=1e-4, device='auto', precondition=True, primal_weight_update = True, adaptive_stepsize = True, infeasibility_detect = False, verbose=False, support_sparse = False, max_kkt = 100000, time_limit=3600,fishnet=False):
    '''
    ...
    try:
        ...
        #  --- Fishnet initialization --- 
            ...
            x0, y0 = None, None
            if fishnet:
                x0, y0 = fishnet_casting.spectral_cast(
